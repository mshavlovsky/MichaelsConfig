" Vim color file - SolarizedDarkCinnamon
" The colorscheme matches default terminal palette in Linux Mint 17 Cinnamon 
" This file should be placed in ~/.vim/colors directory
" Generated by http://bytefluent.com/vivify 2014-08-25
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
set t_Co=256
let g:colors_name = "SolarizedDarkCinnamon_modified"
...
hi Comment guifg=#2aa197 guibg=NONE guisp=NONE gui=italic ctermfg=37 ctermbg=NONE cterm=NONE
hi Character guifg=#586e75 guibg=NONE guisp=NONE gui=NONE ctermfg=66 ctermbg=NONE cterm=NONE
...
hi CursorLine guifg=#e2e4e5 guibg=#565859 guisp=#565859 gui=underline ctermfg=254 ctermbg=240 cterm=underline
...
hi String guifg=#5f99cf guibg=NONE guisp=NONE gui=NONE ctermfg=74 ctermbg=NONE cterm=NONE
